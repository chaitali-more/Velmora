        ...
        <div className="grid gap-4 lg:grid-cols-[1fr_1.08fr] lg:gap-5">
          <section className="rounded-3xl border border-slate-200/80 bg-white p-5 sm:p-6 dark:border-white/10 dark:bg-slate-900/65 dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.03),0_16px_40px_rgba(0,0,0,0.5)]">
            ...
            <div className="mt-6 sm:mt-7">
              <div className="mb-5 grid grid-cols-2 gap-2 rounded-2xl border border-slate-200 bg-slate-50 p-1.5 dark:border-white/10 dark:bg-slate-950/60">
                <button
                  type="button"
              ...
              <div className="mt-5 grid grid-cols-1 gap-3 sm:grid-cols-2">
                <button
                  ...
                  className="rounded-2xl bg-gradient-to-br from-cyan-400 via-violet-500 to-fuchsia-500 py-4 text-base font-bold text-white shadow-[0_14px_28px_rgba(167,139,250,0.45)] transition hover:-translate-y-0.5 hover:shadow-[0_18px_36px_rgba(167,139,250,0.55)] disabled:cursor-not-allowed disabled:opacity-70 disabled:hover:translate-y-0"
                >
          ...
          <section className="relative overflow-hidden rounded-3xl border border-slate-200/80 bg-white p-5 sm:p-6 dark:border-white/10 dark:bg-slate-900/70 dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.03),0_20px_52px_rgba(0,0,0,0.55)]">
            ...
            <div className="relative z-10 flex h-full min-h-[420px] rounded-[1.75rem] border border-cyan-100/80 bg-[radial-gradient(circle_at_8%_94%,rgba(124,58,237,0.1),transparent_30%),radial-gradient(circle_at_96%_0%,rgba(34,211,238,0.16),transparent_34%),linear-gradient(135deg,#ffffff_0%,#f8fafc_100%)] p-6 shadow-[0_24px_64px_rgba(15,23,42,0.12)] sm:min-h-[520px] sm:p-8 dark:border-slate-700/70 dark:bg-[radial-gradient(circle_at_8%_94%,rgba(109,40,217,0.34),transparent_30%),radial-gradient(circle_at_96%_0%,rgba(8,145,178,0.36),transparent_34%),linear-gradient(135deg,#0b1020_0%,#101827_100%)] dark:shadow-[0_28px_70px_rgba(2,6,23,0.42)]">
              {qrCodeUrl ? (
                <div className="flex min-h-full w-full flex-col items-center justify-center text-center">
                  ...
                  <a
                    ...
                    className="mt-5 inline-flex rounded-2xl bg-gradient-to-br from-cyan-400 via-violet-500 to-fuchsia-500 px-6 py-4 text-base font-bold text-white shadow-[0_14px_28px_rgba(167,139,250,0.45)] transition hover:-translate-y-0.5 hover:shadow-[0_18px_36px_rgba(167,139,250,0.55)]"
                  >
                    Download QR Code
                  </a>
                </div>
                ...
                <div className="flex min-h-full w-full flex-col items-center justify-center rounded-[1.5rem] border border-dashed border-cyan-300/60 px-5 py-16 text-center dark:border-cyan-400/25 sm:px-8">
                  <div className="rounded-xl border border-transparent bg-gradient-to-br from-cyan-400 via-violet-500 to-fuchsia-500 px-3 py-3 text-sm font-bold capitalize text-white shadow-[0_14px_28px_rgba(167,139,250,0.45)]">
                    Result Panel
                  </div>
