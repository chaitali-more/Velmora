...
import type { CalorieUnitToggleProps } from "@/types/calorie";

export default function UnitToggle({ unit, onChange }: CalorieUnitToggleProps) {
  return (
