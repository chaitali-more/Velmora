  ...
  return (
    <div className="mb-6 flex flex-col gap-5">
      ...
      <div>
        ...
        <p className="mt-2 rounded-xl border border-white/70 bg-white/75 px-4 py-3 text-sm leading-relaxed text-slate-600 dark:border-white/10 dark:bg-slate-900/80 dark:text-slate-300">
